...
const api = {
  ...
  employees: {
    ...
    update: (id: number, payload: unknown) => ipcRenderer.invoke('employees:update', id, payload),
    remove: (id: number) => ipcRenderer.invoke('employees:delete', id)
  },
  payroll: {
    send: (payload: unknown) => ipcRenderer.invoke('payroll:send', payload),
